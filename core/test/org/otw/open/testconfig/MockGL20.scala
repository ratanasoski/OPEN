...
/**
  ...
  */
class MockGL20 extends GL20 {
  override def glUseProgram(program: Int) = {}

  override def glCreateProgram(): Int = 1
  ...
  override def glGenBuffer(): Int = 1
  ...
  override def glIsBuffer(buffer: Int): Boolean = false
  ...
  override def glGetAttribLocation(program: Int, name: String): Int = 1
  ...
  override def glIsRenderbuffer(renderbuffer: Int): Boolean = false
  ...
  override def glGenFramebuffer(): Int = 1
  ...
  override def glIsProgram(program: Int): Boolean = false

  override def glGetUniformLocation(program: Int, name: String): Int = 1
  ...
  override def glGenRenderbuffer(): Int = 1
  ...
  override def glIsEnabled(cap: Int): Boolean = false

  override def glGenTexture(): Int = 1
  ...
  override def glIsShader(shader: Int): Boolean = false
  ...
  override def glCreateShader(`type`: Int): Int = 1
  ...
  override def glCheckFramebufferStatus(target: Int): Int = 1
